...
class DomainWorker:
        ...
        try:
            ...
            if result and "error" not in result:
                ...
                try:
                    ...
                    print(f"[{self.worker_id}] ⚠️ DB save failed for {domain}: {db_error}")
    ...
    def stop(self):
        """Stop the worker."""
        self.running = False
        print(f"[{self.worker_id}] Stopped after processing {self.processed_count} domains")
...
def main():
    ...
    if not redis.ping():
        ...
        print("  Windows: Install Redis from https://github.com/microsoftarchive/redis/releases")
